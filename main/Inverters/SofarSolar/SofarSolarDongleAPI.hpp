...
private:
    ...
    bool sendReadDataRequest(NetworkClient &client, uint8_t sequenceNumber, uint16_t addr, uint8_t len, uint32_t sn)
    {
        ...
        byte request[] = {
            ...
            (byte)(sequenceNumber & 0xff) /*Request number*/,
            0 /*Request number*/,
            (byte)(sn & 0xff) /*Serial number*/,
            (byte)((sn >> 8) & 0xff) /*Serial number*/,
            (byte)((sn >> 16) & 0xff) /*Serial number*/,
            (byte)((sn >> 24) & 0xff) /*Serial number*/, 0x02 /*Frame type*/,
            0x00 /*Sensor type*/,
            0x00 /*Sensor type*/,
