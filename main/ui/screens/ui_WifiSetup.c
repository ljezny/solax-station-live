...
lv_obj_remove_flag( ui_WifiSetup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
ui_wifiSetupCompleteButton = lv_button_create(ui_Container15);
lv_obj_set_height( ui_wifiSetupCompleteButton, 50);
lv_obj_set_width( ui_wifiSetupCompleteButton, lv_pct(100));
lv_obj_set_x( ui_wifiSetupCompleteButton, 347 );
lv_obj_set_y( ui_wifiSetupCompleteButton, -392 );
...
lv_obj_remove_flag( ui_wifiSetupCompleteButton, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
