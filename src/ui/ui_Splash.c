...
lv_obj_t *ui_Splash = NULL;lv_obj_t *ui_Image1 = NULL;lv_obj_t *ui_fwVersionLabel = NULL;lv_obj_t *ui_ESPIdLabel = NULL;lv_obj_t *ui_splashLabel = NULL;
// event funtions
