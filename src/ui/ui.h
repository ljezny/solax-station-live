...
extern lv_obj_t *ui_batteryChargedTotalLabel;
extern lv_obj_t *ui_batteryDischargedTotalLabel;
...
extern lv_obj_t *ui_gridSellTotalLabel;
extern lv_obj_t *ui_gridBuyTotalLabel;
